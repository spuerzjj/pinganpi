...
const entries: MiniProgramFunctionBuildEntry[] = [
  {
    name: "pinganpi-ai",
    entry: "server/miniprogram-functions/pinganpi-ai.ts",
    description: "平安批小程序 AI event 云函数",
  },
  {
    name: "pinganpi-sync",
    entry: "server/miniprogram-functions/pinganpi-sync.ts",
    description: "平安批小程序同步 event 云函数",
  },
  {
    name: "pinganpi-account",
    entry: "server/miniprogram-functions/pinganpi-account.ts",
    description: "平安批小程序账号 event 云函数",
  },
  {
    name: "pinganpi-pair",
    entry: "server/miniprogram-functions/pinganpi-pair.ts",
