...
import { createRoadmapViewModel, getPhaseStatusLabel, type PhaseStatus, type RoadmapData } from "./roadmap";
  ...
  <main class="page">
    ...
    <section class="panel">
      <div class="section-head">
        ...
        <div class="progress-shell" aria-label="完成进度">
          <div class="progress-bar" :style="{ width: `${model.completionPercent}%` }"></div>
        </div>
      </div>
