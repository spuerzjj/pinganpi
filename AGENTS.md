...
6. **阶段 26：小程序登录与双人关系真实闭环**
   ...
   - 微信小程序 AppID 关联、`open-type="getPhoneNumber"` 真机 code、手机号能力、短信真实发送和双手机号加入验证进入阶段 29 / 30。
